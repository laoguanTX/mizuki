...
export const siteConfig: SiteConfig = {
	title: "老官童鞋gogo的博客",
	subtitle: "laoguanTX's Blog",
	siteURL: "https://www.laoguantx.cn/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2020-10-01", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		src: {
			desktop: [
				"http://laoguantx.top/Mienar/api.php",
		...
		imageApi: {
			...
			url: "http://laoguantx.top/Mienar/api.php", // API地址，返回每行一个图片链接的文本
		},
		...
		homeText: {
			...
			title: ["老官童鞋gogo的博客", "老官童鞋gogo的笔记本"], // 主页横幅主标题
		...
		credit: {
			...
			text: "MIENAR", // 要显示的来源文本
			url: "https://mienar.com/", // （可选）原始艺术品或艺术家页面的 URL 链接
		},
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	src: {
		desktop: [
			"http://laoguantx.top/landscape/api.php",
			// "/assets/desktop-banner/2.webp",
			// "/assets/desktop-banner/3.webp",
			// "/assets/desktop-banner/4.webp",
			// "/assets/desktop-banner/5.webp",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "程设计科",
					url: "/archive/?category=程设计科",
					children: [
						{
							name: "编程语言",
							url: "/archive/?category=编程语言",
						},
						{
							name: "人工智能",
							url: "/archive/?category=人工智能",
						},
						{
							name: "算法与数据结构",
							url: "/archive/?category=算法与数据结构",
						},
						{
							name: "软件发布",
							url: "/archive/?category=软件发布",
						},
					],
				},
				{
					name: "数学",
					url: "/archive/?category=数学",
					children: [
						{
							name: "大中衔接",
							url: "/archive/?category=大中衔接",
						},
						{
							name: "线性代数",
							url: "/archive/?category=线性代数",
						},
						{
							name: "高等数学",
							url: "/archive/?category=高等数学",
						},
						{
							name: "概率论与数理统计",
							url: "/archive/?category=概率论与数理统计",
						},
						{
							name: "数学物理方法",
							url: "/archive/?category=数学物理方法",
						},
					],
				},
				{
					name: "物理",
					url: "/archive/?category=物理",
					children: [
						{
							name: "普通物理学",
							url: "/archive/?category=普通物理学",
						},
						{
							name: "实验",
							url: "/archive/?category=实验",
						},
						{
							name: "力学",
							url: "/archive/?category=力学",
						},
					],
				},
				{
					name: "其他课程基础",
					url: "/archive/?category=其他课程基础",
					children: [
						{
							name: "普通化学",
							url: "/archive/?category=普通化学",
						},
						{
							name: "无线网络应用",
							url: "/archive/?category=无线网络应用",
						},
					],
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "https://q1.qlogo.cn/g?b=qq&nk=1876949312&s=640", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "老官童鞋gogo",
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/387966744",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/laoguanTX",
		},
		{
			name: "Discord",
			icon: "fa6-brands:discord",
			url: "https://discord.gg/TV7vRvfc",
		},
	],
};
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.laoguantx.cn",
		lang: SITE_LANG,
	},
};
